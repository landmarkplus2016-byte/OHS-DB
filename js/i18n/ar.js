...
export const ar = {
  ...
  dash_rdt_title: 'الفحص العشوائي المرتقب لهذا الشهر',
  ...
  section_quals: 'الشهادات المعتمدة',
  section_drug: 'تحليل مخدرات عشوائي',
  ...
  legal_permissions: 'قيم موافقة VF',
  ...
  // ---------- Settings → Lists ----------
  lists_intro: 'أضف خيارات إلى أي قائمة في أي وقت. إعادة تسمية قيمة أو حذفها يؤثر على القوائم المنسدلة فقط — الموظفون الذين يستخدمونها يحتفظون بها.',
  toast_lists_updated: 'تم تحديث القوائم',
  list_add: 'إضافة',
  list_add_placeholder: 'أضف خيارًا…',
  list_empty: 'لا توجد خيارات بعد.',
  edit_list_item_title: 'إعادة تسمية الخيار',
  confirm_delete_list_item_title: 'حذف الخيار؟',
  confirm_delete_list_item_msg: 'إزالة "{value}" من {list}؟ الموظفون الذين يستخدمونها يحتفظون بها.',
  toast_list_item_added: 'تمت إضافة "{value}"',
  toast_list_item_removed: 'تمت إزالة "{value}"',
  toast_list_item_renamed: 'أعيدت التسمية إلى "{value}"',
  err_list_item_empty: 'أدخل قيمة أولًا.',
  err_list_item_duplicate: '"{value}" موجودة بالفعل في القائمة.',
  ...
  // ---------- Excel import ----------
  import_preview_title: 'معاينة استيراد Excel',
  import_preview_intro: 'لن يُستورد شيء حتى تؤكد. راجع الصفوف المعلَّمة بالأسفل.',
  import_parse_error: 'تعذّرت قراءة هذا الملف كجدول بيانات.',
  import_no_rows: 'لم يُعثر على صفوف قابلة للاستيراد في هذا الملف.',
  summary_new: 'جديد',
  summary_duplicates: 'مكرر',
  summary_unknowns: 'قيم غير معروفة',
  summary_skipped: 'سيتم تخطيه',
  col_row: 'الصف',
  col_action: 'الإجراء',
  act_import: 'استيراد',
  act_skip: 'تخطي',
  act_overwrite: 'استبدال',
  act_add_new: 'إضافة كجديد',
  act_add_sub_import: 'إضافة "{value}" إلى المقاولين الفرعيين والاستيراد',
  act_add_title_import: 'إضافة "{value}" إلى المسميات والاستيراد',
  status_new: 'جديد',
  status_duplicate: 'مكرر',
  status_unknown_sub: 'مقاول فرعي غير معروف',
  status_unknown_title: 'مسمى غير معروف',
  reason_duplicate: 'الرقم القومي {natid} مسجل بالفعل لـ {name}',
  ...
  warn_sheet_missing: 'لا توجد ورقة "{sheet}" في هذا الملف.',
  warn_no_header: 'تعذّر العثور على صف العناوين في ورقة "{sheet}" — تم تخطيها.',
  warn_unmapped_cols: '"{sheet}": هذه الأعمدة غير معروفة وتم تجاهلها — {cols}',
  warn_row_skipped: 'الصف {row} في "{sheet}": تم تخطيه، لا يوجد اسم أو رقم قومي.',
  warn_bad_date: 'الصف {row} في "{sheet}": تعذّرت قراءة التاريخ "{value}" — تُرك فارغًا.',
  ...
  // ---------- Officer app ----------
  officer_app_name: 'فحص الميدان',
  officer_app_sub: 'لاندمارك',
  officer_login_title: 'دخول ضابط السلامة',
  officer_setup_title: 'إعداد لأول مرة',
  paste_url: 'الصق رابط Apps Script',
  setup_save: 'حفظ ومتابعة',
  setup_link: 'إعداد رابط المزامنة',
  setup_needed: 'لا يوجد رابط مزامنة بعد.',
  back_to_signin: 'العودة لتسجيل الدخول',
  sync_err_bad_url: 'هذا لا يبدو رابط https:// صحيحاً.',
  sync_signin_title: 'سجّل الدخول للمزامنة',
  sync_signin_msg: 'كلمة السر لا تُحفظ على هذا الهاتف، من فضلك أدخلها مرة أخرى لجلب بيانات محدثة.',
  syncing: 'جاري المزامنة…',
  n_days_short: '{days} يوم',
  as_of: 'البيانات حتى',
  sync_now: 'مزامنة',
  synced: 'تمت المزامنة',
  ...
  sync_err_network: 'تعذر الوصول إلى الخادم. تحقق من اتصالك وحاول مرة أخرى.',
